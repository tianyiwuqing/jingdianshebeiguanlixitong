...
<div class="x-body">
    <form class="layui-form" id="addequipment" method="post"
        ...
        <div class="layui-form-item">
            <label for="departmentaddress" class="layui-form-label">
                <span class="x-red">*</span>部门地址
            </label>
            <div class="layui-input-inline">
                <input type="text" id="departmentaddress" name="departmentaddress" required="" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label for="departmenttelephone" class="layui-form-label">
                <span class="x-red">*</span>部门电话
            </label>
            <div class="layui-input-inline">
                <input type="text" id="departmenttelephone" name="departmenttelephone" required="" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
