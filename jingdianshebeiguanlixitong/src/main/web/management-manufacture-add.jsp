...
<div class="x-body">
    <form class="layui-form" id="addequipment" method="post"
        ...
        <div class="layui-form-item">
            <label for="manufacturerid" class="layui-form-label">
                <span class="x-red">*</span>生产商id
            </label>
            <div class="layui-input-inline">
                <input type="text" id="manufacturerid" name="manufacturerid" required="" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <%--@declare id="manufacturername"--%><label for="manufacturername" class="layui-form-label">
                <span class="x-red">*</span>生产商名称
            </label>
            <div class="layui-input-inline">
                <input type="text" id="manufacturername" name="manufacturername" required="" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label for="manufactureraddress" class="layui-form-label">
                <span class="x-red">*</span>生产商地址
            </label>
            <div class="layui-input-inline">
                <input type="text" id="manufactureraddress" name="manufactureraddress" required="" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label for="manufacturertelephone" class="layui-form-label">
                <span class="x-red">*</span>生产商电话
            </label>
            <div class="layui-input-inline">
                <input type="text" id="manufacturertelephone" name="manufacturertelephone" required="" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
